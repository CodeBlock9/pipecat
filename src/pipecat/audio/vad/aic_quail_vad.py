...
class AICQuailVADAnalyzer(VADAnalyzer):
    ...
    def __init__(
        ...
        *,
        ...
        # Eager model load shifts CDN download out of the hot path. The base
        # analyzer owns no per-instance executor, so a construction failure
        # must not shut down the process-wide VAD pool.
