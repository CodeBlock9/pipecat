...
class TestAICQuailVADAnalyzer(unittest.IsolatedAsyncioTestCase):
    ...
    def test_init_leaves_shared_inference_pool_alive_on_failure(self):
    ...
    def test_construction_eagerly_loads_model_via_model_path(self):
        ...
        mocks["Model"].from_file.assert_called_once_with(str(Path("/tmp/custom.aicmodel")))
